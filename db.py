...
DB_ADMIN_USER = "admin"
DB_ADMIN_PASSWORD = os.environ.get("ADMIN_PASSWORD")
...
def init_db():
    if not DB_ADMIN_PASSWORD or not DB_ADMIN_PASSWORD.strip():
        raise RuntimeError("Set ADMIN_PASSWORD before initializing the database.")
